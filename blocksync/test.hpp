...
TEST_CASE("Basic Migrate to Network Sync", "[blocksync::]")
{
...

	{
		...
		volstore::Image server_store("store2");
		volstore::BinaryStore<volstore::Image> server(server_store);

		std::this_thread::sleep_for(std::chrono::milliseconds(500));

		blocksync::Sync<volstore::Image, volstore::BinaryStoreClient> sync_handle("sync", "store1", "127.0.0.1");
		...
		auto merge = sync_handle.MigrateFolder(result2.key, d8u::util::default_domain, true, 64, 64);
